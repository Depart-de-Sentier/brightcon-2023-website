<template>
  <div class="container">
    <h2>Instructors for Brightcon 2023</h2>
    <div v-for="q in instructors" :key="q.name">
      <div class="row">
        <div class="col">
          <div class="card" :id="q.instid">
            <header>
              <h4>
...
const instructors = ref([
  ...
  },
  {
    ...
    designation: "PhD in Life-Cycle Assessment for Sustainable Aviation",
